    ...
    try {
        ...
        if ($result) {
            ...
            if($city == "Karachi") {
                ...
                $_SESSION["agent_name"] = $result["agent_name"];
                                    ...
                                    <form action="agent_login.php" method="post">
                                        ...
                                        <div class="">
                                                ...
                                                <select id="city" name="city" class="form-control form-select">
                                                    <option value="Karachi" <?php echo isset($_POST["city"])? ($_POST["city"] == "Karachi"? "selected": "") : "";  ?>>Karachi</option>
                                                    <option value="Lahore" <?php echo isset($_POST["city"])? ($_POST["city"] == "Lahore"? "selected": "") : "";  ?>>Lahore</option>
                                                    <option value="Islamabad" <?php echo isset($_POST["city"])? ($_POST["city"] == "Islamabad"? "selected": "") : "";  ?>>Islamabad</option>
                                                    <option value="Quetta" <?php echo isset($_POST["city"])? ($_POST["city"] == "Quetta"? "selected": "") : "";  ?>>Quetta</option>
                                                </select>
                                            </div>
                                        <button type="submit" class="btn_1 full_width text-center" name="btn_login">Log in</button>
                                        <p>Login as? <a data-toggle="modal" data-target="#sing_up" data-dismiss="modal" href="admin_login.php"> Admin</a></p>
                                    </form>
                                </div>
                            </div>
                        </div>
