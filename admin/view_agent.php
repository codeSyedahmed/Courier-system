...
try {
    $stmt = $conn->prepare("SELECT A.agent_id, A.agent_name, A.city, A.email_address, A.agent_password, A.contact_num, A.inserted_at, A.updated_at, B.branch_name, C.name
        FROM tb_Agent A INNER JOIN tb_Branch B ON A.branch_location = B.branch_id 
        INNER JOIN tb_Admin C ON C.admin_id = A.updated_by_admin
...
// delete product
if (isset($_GET["btn_delete_agent"])) {
    try {
            ...
            <div class="col-12">
                <div class="page_title_box d-flex flex-wrap align-items-center justify-content-between">
                    <div class="page_title_left d-flex align-items-center">
                        <h3 class="f_s_25 f_w_700 dark_text mr_30">Agent Details</h3>
                    ...
                    <div class="page_title_right">
                        <a id="btn_add_new_product" href="agents.php" class="btn_1">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-12">
                <div class="modal-header justify-content-start theme_bg_1">
                    <h5 class="modal-title text_white">Agent Details</h5>
                </div>
                <div class="white_card card_height_100 p-3">
                    <div class="white_card_body">
                            ...
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $result["agent_password"]; ?></td>
                                    </tr>
                                    <tr>
                        ...
                        <div class="d-flex justify-content-between">
                            <a href="edit_agent.php?id=<?php echo $result["agent_id"]; ?>" class="btn btn-secondary mb-3">Edit Agent</a>

                            <button type="button" class="btn btn-secondary mb-3" data-bs-toggle="modal" data-bs-target="#view_delete_modal">Delete Agent</button>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <form action="view_agent.php" method="get">
                    <input type="hidden" name="id" value="<?php echo $result["agent_id"]; ?>">
